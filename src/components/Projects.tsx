...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Tech Detects Deception: Our project exposes deepfakes, safeguarding truth from digital manipulation. ",
      tech: [
        "React",
        "Flask",
        "Tensorflow",
    ...
    },
    {
      ...
      description:
        "Boost Developer Efficiency: Harness AI-powered automation to accelerate content creation, streamline video production, and optimize meeting workflows.",
      tech: [
        "React",
        "Python",
        "AWS",
