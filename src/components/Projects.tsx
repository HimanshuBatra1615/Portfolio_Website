...
const Projects = () => {
  ...
  const projects = [
    {
      title: "CognitiveRAN – Intelligent Network Optimization for Open 5G Systems",
      description:
        "CognitiveRAN is a machine learning–driven framework designed to improve the efficiency, resilience, and adaptability of modern self-optimizing Open RAN (5G) networks.",
      tech: [
        "Next.js",
        "React",
        "Typescript",
      ...
      image:"/cognitive.png",
      liveUrl: "#",
      githubUrl: "https://github.com/HimanshuBatra1615/CognitiveRAN-Intelligent-Network-Optimization-for-Open-5G-Systems",
    },
    {
    ...
    },
    {
      title: "Vizcureot",
      description:
        "Vizcureot Your Smart Sensor Assistant – From AI-Powered Detection to Instant Code and Connection Diagrams.",
      tech: ["Firebase", "Django", "MongoDB Atlas", "Python", "Langchain", " YOLOv8", "GenAI", "GAN", "CrewAI", "Gemini"],
      image: "/project3.png",
      liveUrl: "#",
      githubUrl:
        "#",
    ...
    {
      title: "PixelForge AI – ESRGAN-Based Image Enhancement System",
      description:
        "AI and deep learning–based image enhancement application powered by ESRGAN. It improves low-resolution images by generating high-quality, detailed outputs using advanced super-resolution techniques. ",
      tech: [
        "Python",
        "PyTorch",
        "OpenCV",
      ...
      image: "/pixel.png",
      liveUrl: "#",
      githubUrl: "https://github.com/HimanshuBatra1615/PixelForge-AI",
    },
    {
      title: "IdentiFlow – Predictive Analytics Platform for Citizen Service Optimization",
      description:
        "IdentiFlow is an AI-powered analytics platform designed to improve accessibility and planning for Aadhaar service centers through predictive modeling and behavioral analysis.",
      tech: [
        "Flask",
        "Python",
        "LightGBM",
      ...
      image: "/Identiflow.png",
      liveUrl: "#",
      githubUrl: "https://github.com/HimanshuBatra1615/IdentiFlow-Predictive-Analytics-Platform-for-Citizen-Service-Optimization",
    },
  ];
